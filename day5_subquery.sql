...
/* ===================== AGGREGATE(math gibi) METOT KULLANIMI ===========================
...
-- as toplam_maas : parantes icine isim vermek icin as yazilmak zorunda degil bir bosluk olmali
...
/* -----------------------------------------------------------------------------
 ...
 -- round : virgulden sonrasini yuvarlar
