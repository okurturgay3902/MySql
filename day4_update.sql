...
/* -----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/ 
   update tedarikciler set firma_ismi='Ipek Bilgin' where firma_ismi='casper';
...
/*-----------------------------------------------------------------------------
 ...
 degistiriniz.
 -----------------------------------------------------------------------------*/
 delete from tedarikciler; -- tabloyu yenilemek icin yaptik
 -- baba silinince cocukda gitti yeniden insert yapilmali
   
   UPDATE urunler set urun_ismi=(select firma_ismi from tedarikciler where irtibat_ismi= 'Adam Eva')
