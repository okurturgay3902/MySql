-- ============================== DELETE ===================================  
    ...
    drop table ogrenciler; -- tum tabloyu siler
...
/* ----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/     
   delete from ogrenciler; -- tablo icerini siler
   drop table ogrenciler; -- tum tabloyu siler
   SELECT * FROM ogrenciler;
   rollback to abc; -- silinen tablo icini geri getirir ancak kayitta savepoint abc; yapti isek
...
/* ======================== DELETE - TRUNCATE - DROP ============================   
  ...
  1-) TRUNCATE komutu DELETE komutu gibi bir tablodaki verilerin tamamını siler.
		ancak geri getirilemez kalici siler
