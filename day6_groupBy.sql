...
order by maks;
 ...
 /* aggregate (math) fonksiyonlari ile ilgili kosul koymak icin group by dan sonra
 having cumlecigi kullanilir*/
 ...
 -- having not max(urun_miktari)=min(urun_miktari) de olabilir 
